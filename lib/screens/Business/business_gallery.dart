...
import 'package:communityapp/screens/Business/bussiness_full_image.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class BusinessGallery extends StatefulWidget {
  /*const BusinessGallery({Key? key}) : super(key: key);*/

  String? bussiness_id;
  BusinessGallery({required this.bussiness_id});
...
class _BusinessGalleryState extends State<BusinessGallery> {
  ...
  String? img,name,category,location,opening_time,closing_time,email,website,
      contact,whatsapp,subCategory,about,opening_day,closing_day,user_id;
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (BuildContext, int index) {
                          return InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(
                                  builder: (context)=>full_image_bussiness(
                                    image: gallery[index].toString(),
