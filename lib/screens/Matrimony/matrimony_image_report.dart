...
class matrimony_image_report extends StatefulWidget {
  String? image,parent_user_id;
  matrimony_image_report({required this.image,required this.parent_user_id});

  @override
  State<matrimony_image_report> createState() => _matrimony_image_reportState();
}

class _matrimony_image_reportState extends State<matrimony_image_report> {
  @override
