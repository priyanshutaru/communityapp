...
class MatrimonyProfile extends StatefulWidget {
  String? mat_id,image,name,skin_tone,height,dob_time,dobtime_birth,gender,age,education,district;
  MatrimonyProfile({required this.mat_id,this.age,this.dob_time,this.education,this.district,this.dobtime_birth,this.gender,this.height,this.image,this.name,this.skin_tone});
  @override
  State<MatrimonyProfile> createState() => _MatrimonyProfileState();
}
class _MatrimonyProfileState extends State<MatrimonyProfile> {
