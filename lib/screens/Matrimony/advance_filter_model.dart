class advance_filter_model {
  List<Filtter_Model>? data;

  advance_filter_model({this.data});

  advance_filter_model.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Filtter_Model>[];
      json['data'].forEach((v) {
        data!.add(new Filtter_Model.fromJson(v));
      });
    }
  }
...
class Filtter_Model {
  ...
  Filtter_Model.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    matId = json['mat_id'];
    userId = json['user_id'];
