class advance_search_model {
  List<Advance_Data>? data;
  int? totalResultFound;

  advance_search_model({this.data, this.totalResultFound});

  advance_search_model.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Advance_Data>[];
      json['data'].forEach((v) {
        data!.add(new Advance_Data.fromJson(v));
      });
    }
...
class Advance_Data {
  ...
  Advance_Data.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
