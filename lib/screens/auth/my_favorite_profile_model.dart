class my_favorite_profile_model {
  List<Favorite>? data;

  my_favorite_profile_model({this.data});

  my_favorite_profile_model.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Favorite>[];
      json['data'].forEach((v) {
...
class Favorite {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['followed_user_id'] = this.followedUserId;
