class get_anniversery_model {
  String? statusMessage;
  List<Anniversery>? details;

  get_anniversery_model({this.statusMessage, this.details});

  get_anniversery_model.fromJson(Map<String, dynamic> json) {
    statusMessage = json['status_message'];
    if (json['details'] != null) {
      details = <Anniversery>[];
      json['details'].forEach((v) {
        details!.add(new Anniversery.fromJson(v));
      });
    }
  }
...
class Anniversery {
  ...
  Anniversery.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
